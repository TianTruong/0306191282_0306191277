        ...
        child: Column(children: [
          ...
          Expanded(
            ...
            children: [
              ...
              buildContact('Phòng Hành chính - Quản trị', '028.38212360 (11)',
                  'ktcaothang@caothang.edu.vn', 'hcqt.caothang.edu.vn'),
              Padding(
                padding: const EdgeInsets.only(top: 5, bottom: 5),
              ...
              buildContact('Khoa Cơ khí động lực', '028.38212360 ',
                  'nguyenngocthanh@caothang.edu.vn', 'ckdl.caothang.edu.vn'),
              buildContact('Khoa Điện - Điện tử', '028.38212360 ',
                  'pvthanh@caothang.edu.vn ', 'ddt.caothang.edu.vn'),
              buildContact('Khoa Công nghệ Nhiệt - Lạnh', '028.38212360 ',
                  'lequanghuy@caothang.edu.vn ', 'nhietlanh.caothang.edu.vn'),
              buildContact('Khoa Công nghệ thông tin', '028.38212360 (33) ',
                  'nvdzung@caothang.edu.vn ', 'cntt.caothang.edu.vn'),
